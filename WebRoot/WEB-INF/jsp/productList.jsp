...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<a href="#">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.jpg" alt="网站图标">
			</a>
		</div>
	</div>
	<div class="span9">
...
<div class="container productList">
						...
						<dl>
							<dt>
								...
								<s:iterator var="cs" value="#c.categoryseconds">
									<dd>
										<a href="${ pageContext.request.contextPath }/product_findByCsid.action?ccid=<s:property value="#cs.ccid"/>&page=1"><s:property value="#cs.ccname"/></a>
									</dd>
								</s:iterator>	
						</dl>
				</s:iterator>		
	...
	<div class="pagination">
		...
		<s:if test="ccid != null">
			<s:if test="pageBean.page != 1">
				<a href="${ pageContext.request.contextPath }/product_findByCsid.action?ccid=<s:property value="ccid"/>&page=1" class="firstPage">&nbsp;</a>
				<a href="${ pageContext.request.contextPath }/product_findByCsid.action?ccid=<s:property value="ccid"/>&page=<s:property value="pageBean.page-1"/>" class="previousPage">&nbsp;</a>
			</s:if>
			
			<s:iterator var="i" begin="1" end="pageBean.totalPage">
				<s:if test="pageBean.page != #i">
					<a href="${ pageContext.request.contextPath }/product_findByCsid.action?ccid=<s:property value="ccid"/>&page=<s:property value="#i"/>"><s:property value="#i"/></a>
				</s:if>
				<s:else>
					<span class="currentPage"><s:property value="#i"/></span>
				</s:else>
